		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "carService",
									"targetURL": "#comcarassignment6-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcarassignment6-display": {
								"semanticObject": "comcarassignment6",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.car.assignment6",
									"url": sap.ui.require.toUrl("com/car/assignment6")
								}
							}
						}
					}
